...
public enum CursorKind {
    ...
    private static final Map<Integer, CursorKind> BY_VALUE = new HashMap<>();
     ...
     * Pure Java check on the value range (CXCursor_FirstDecl..CXCursor_LastDecl = 1..39).
     */
    public boolean isDeclaration() {
        return this.value >= 1 && this.value <= 39;
    }

    /**
     * Returns the CursorKind for the given integer value, or {@code null} if unknown.
     */
    ...
    static {
        EnumSet.allOf(CursorKind.class).forEach(e -> BY_VALUE.put(e.value, e));
    }
}
